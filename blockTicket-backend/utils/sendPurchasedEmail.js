...
const sendPurchasedEmail = async ({
  ...
  const loginUrl = `https://www.blocktickets.io/login?redirect_url="ticket`;
  return sendEmail({
    to: email,
    ...
    *[x-apple-data-detectors],  /* iOS */
    ...
    Dear <strong>${name?name:email},</strong><br>
...
<br><br>
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" width="100%" class="details">
        <tr>
         ...
         <tr>
            ...
            <td><STRONG>${ticketOrderId}</STRONG></td>
        </tr>
         <tr>
    ...
    <strong style="padding-bottom: 6px; float: left;">Price DetailPrice Detail</strong><br/>
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" width="100%" class="details">
    // <tr>
    //     <td colspan="2" style="width: 284px;border: 0;"><strong>Price Detail</strong></td>
        
    // </tr>
    <tr>
            <td>Ticket Price</td>
            <td><STRONG>${currency + " " + ticketPrice["ticket_price"]?.toFixed(2)}</STRONG></td>
        </tr>
         <tr>
            <td>Convenience Fee</td>
            <td><STRONG>${currency + " " + ticketPrice["total_convenience_fee"].toFixed(2)}</STRONG></td>
        </tr>
         <tr>
            <td>GST on Conv Fee</td>
            <td><STRONG>${currency + " " + ticketPrice["total_gst_convenience_fee"].toFixed(2)}</STRONG></td>
        </tr>
        <tr>
            <td>Total Price Paid</td>
            <td><STRONG>${currency + " " + ticketPrice["finalPrice"].toFixed(2)}</STRONG></td>
        </tr>
</table><br>
<table align="center" role="presentation" cellspacing="0" cellpadding="0" width="100%" class="details">
    <tr>
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="85%" style="margin: auto; " class = "increase">
